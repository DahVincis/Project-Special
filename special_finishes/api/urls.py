...
from .views import hello_world, about_company, our_work, home, testimonials, meet_owner, interior_exterior, echo_headers
...
urlpatterns = [
    ...
    path('headers/', echo_headers, name='echo_headers'),
]
